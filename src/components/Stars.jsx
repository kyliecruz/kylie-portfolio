    ...
    <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, pointerEvents: "none", overflow: "hidden" }}>
      <svg viewBox="0 0 1440 220" xmlns="http://www.w3.org/2000/svg"
        ...
        <g>
          ...
          <path d="M0,155 C8,148 18,148 26,153 C30,156 28,162 22,164 C14,166 4,162 0,155 Z" fill="url(#dolphinGrad)">
            <animate attributeName="d"
              values="M0,155 C8,148 18,148 26,153 C30,156 28,162 22,164 C14,166 4,162 0,155 Z;M0,153 C8,144 20,143 28,150 C32,153 30,160 24,162 C14,165 3,160 0,153 Z;M0,155 C8,148 18,148 26,153 C30,156 28,162 22,164 C14,166 4,162 0,155 Z"
